...
import img1 from '../../../src/assets/media/ft1.png'
import img2 from '../../../src/assets/media/ft2.png'
    ...
    return (
        <footer id="footer">
            <div className="footer-main">
                <img src={img1} alt="Elixer" className="bg1" />
                <img src={img2} alt="Elixer" className="bg2" />
                ...
                <div className="container">
                    <div className="wrap-fx">
                        <div className="Copyright">
                            <p>ELIXER 2022- ALL rights reserved</p>
                        </div>
                        <ul className="list">
                            <li>
